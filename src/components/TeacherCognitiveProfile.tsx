...
import { Brain, BookOpen, Users, MessageCircle, Zap } from "lucide-react";
import { students, documents, teacher, statusColor } from "../data/mockData";
...
export function TeacherCognitiveProfile() {
  const { currentCourse, selectedStudentId, setSelectedStudentId, closeCognitive } = useAppState();
